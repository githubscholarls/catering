...
oS.Init({
		...
		PicArr:function(){
			...
			return ['../wwwroot/game/zwdzjs/images/interface/background2.jpg','../wwwroot/game/zwdzjs/images/interface/Tombstones.png','../wwwroot/game/zwdzjs/images/interface/Tombstone_mounds.png',
				PicArr[Pro.CardGif],PicArr[Pro.NormalGif]]
		}(),
		backgroundImage:'../wwwroot/game/zwdzjs/images/interface/background2.jpg',
		CanSelectCard:1,
		DKind:0,
		SunNum:50,
		LevelName:'关卡 2-2',
		...
		FlagToEnd:function(){
			NewImg('imgSF','../wwwroot/game/zwdzjs/images/Card/Plants/FumeShroom.png','left:587px;top:270px',EDAll,{onclick:function(){SelectModal(0)}});
			NewImg('PointerUD','../wwwroot/game/zwdzjs/images/interface/PointerDown.gif','top:235px;left:596px',EDAll);
		}
});
