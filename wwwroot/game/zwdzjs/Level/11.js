...
oS.Init({
		...
		FlagToEnd:function(){
			NewImg('imgSF','../wwwroot/game/zwdzjs/images/Card/Plants/SunShroom.png','left:667px;top:220px',EDAll,{onclick:function(){SelectModal(12)}});
			NewImg('PointerUD','../wwwroot/game/zwdzjs/images/interface/PointerDown.gif','top:185px;left:676px',EDAll);
		}
});
